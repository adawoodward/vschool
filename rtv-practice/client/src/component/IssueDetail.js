...
// const IssueDetail = () => {
//     const { userAxios, comments, setComments, setUserState, postNewComment } = useContext(UserContext);
//     const { _id } = useParams();
...
//         try {
//             await userAxios.delete(`/api/issue/${_id}`);
...
//             // Navigate back to the profile page or handle navigation as needed
//             navigate('/profile');
//         } catch (error) {
...
//             <div>Comment</div>
//             {issueDetail._id ? (
//                 <CommentForm postComment={postNewComment} issueId={issueDetail._id} />
//             ) : (
//                 <p>Loading...</p>
//             )}
//             {/* <p>
