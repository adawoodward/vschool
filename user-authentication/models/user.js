...
userSchema.methods.checkPassword = function(passwordAttempt, callback) {
         // takes the hashed password and the plain text passwords and see if they are the same
         // this.password is the encrypted password here, passwordAttempt is the plain text
